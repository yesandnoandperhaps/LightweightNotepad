...
YONG_MING_TI_LIST = [
    ["上古音", "兩漢六朝","中古音"],
    ["構擬","韻部","轉寫","推導"],
    ['高本漢', '董同龢', '王力體系', '李方桂', '周法高', '斯塔羅斯金①·上古前期', '斯塔羅斯金②·上古後期', '斯塔羅斯金③·詩經音', '白一平', '鄭張尚芳', '潘悟雲', '許思萊', '金理新', '白一平-沙加爾', '郭錫良（表稿）', '郭錫良（手冊）', '斯塔羅斯金·西漢', '斯塔羅斯金·東漢', '許思萊·東漢', '西漢', '東漢', '魏', '晉', '宋北魏後期', '北魏後期北齊', '齊梁陳北周隋', '高本漢', '王力', '董同龢', '李方桂', '周法高', '陳新雄', '蒲立本·前期', '蒲立本·後期', '斯塔羅斯金·中古', '斯塔羅斯金·前期', '斯塔羅斯金·中期', '斯塔羅斯金·後期', '楊力', '金理新', '許思萊', '白一平-沙加爾', '高本漢', '王力', '張世祿', '嚴學宭', '董同龢', '李榮', '蒲立本', '邵榮芬', '鄭張尚芳', '潘悟雲', '楊劍橋', '麥耘','poem'],
    ['西漢', '東漢', '魏', '晉', '宋北魏後期', '北魏後期北齊', '齊梁陳北周隋',"廣韻-基於poem","玉篇-基於poem","平水韻","詞林正韻"],
    ["平上去入","平仄"]]
