...
from function.variables.ProjectPathVariables import N_PATH, P_PATH, Q_PATH, U_PATH, V_PATH, ICON_PATH
...
class OldXiaoLiuRenWindow:
    ...
    def __init__(self,root_main, icon, font_style,function_num):
        ...
        def loop_output2():
            ...
            file_path_csv = filedialog.asksaveasfilename(parent=self.window, defaultextension=".csv",
            ...
            def t_loop_output_x():
                ...
                def loop_output_x():
                    ...
                    match entry___:
                        ...
                        case _:
                            messagebox.showerror("错误", message="请只输入整数", parent=self.window)
                            entry2.pack_forget()
                            text2.pack_forget()
                            entry.pack(padx=5, pady=5, side='right')
                            entry.config(font=font_style)
                ...
                def x_x():
                    ...
                    def entry_row_name_():
                        if entry_row_name.get():
                            try:
                                ...
                                window_x.destroy()
                                self.window.wm_attributes('-disabled', 0)
                    ...
                    self.window.wm_attributes('-disabled', 1)
                    ...
                    entry_row_name.bind('<Control_L>', lambda event: entry2_2_1())
                ...
                def x_x_():
                    ...
                    entry_row_name.bind('<Control_R>', lambda event: entry_row_name_())
                    entry_row_name2.bind('<Control_R>', lambda event: entry_row_name_())
                    entry_row_name3.bind('<Control_R>', lambda event: entry_row_name_())
                    entry_row_name4.bind('<Control_R>', lambda event: entry_row_name_())
                    ...
                    entry_row_name.bind('<Control_L>', lambda event: entry2_2_1())
                    entry_row_name2.bind('<Control_L>', lambda event: entry2_2_1())
                    entry_row_name3.bind('<Control_L>', lambda event: entry2_2_1())
                    entry_row_name4.bind('<Control_L>', lambda event: entry2_2_1())
                ...
                def x_x__():
                    ...
                    def entry_row_name_():
                        ...
                        def x_x__x():
                            ...
                            entry_row_name_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name2_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name3_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name4_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name5_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name6_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name7_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name8_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name9_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name10_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name2_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name3_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name4_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name5_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name6_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name7_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name8_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name9_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name10_.bind('<Control_R>', lambda event: entry_row_name__())
                        ...
                        def x_x__x_():
                            ...
                            entry_row_name9_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name10_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name11_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name12_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name13_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name14_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name15_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name16_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name2_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name3_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name4_.bind('<Control_R>', lambda event: entry_row_name__())
                            ...
                            entry_row_name9_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name10_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name11_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name12_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name13_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name14_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name15_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name16_.bind('<Control_R>', lambda event: entry_row_name__())
                        ...
                        def x_x__x__():
                            ...
                            entry_row_name15_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name16_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name17_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name18_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name19_.bind('<Control_L>', lambda event: entry2_2_2())
                            entry_row_name_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name2_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name3_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name4_.bind('<Control_R>', lambda event: entry_row_name__())
                            ...
                            entry_row_name15_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name16_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name17_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name18_.bind('<Control_R>', lambda event: entry_row_name__())
                            entry_row_name19_.bind('<Control_R>', lambda event: entry_row_name__())
                    ...
                    entry_row_name3.bind('<Control_R>', lambda event: entry_row_name_())
                    entry_row_name4.bind('<Control_R>', lambda event: entry_row_name_())
                    combobox.bind('<Control_R>', lambda event: entry_row_name_())
                    entry_row_name.bind('<Return>', lambda event: entry_row_name2.focus_set())
                    entry_row_name2.bind('<Return>', lambda event: entry_row_name3.focus_set())
                    entry_row_name3.bind('<Return>', lambda event: entry_row_name4.focus_set())
                    ...
                    entry_row_name3.bind('<Control_L>', lambda event: entry2_2_1())
                    entry_row_name4.bind('<Control_L>', lambda event: entry2_2_1())
                    combobox.bind('<Control_L>', lambda event: entry2_2_1())
                ...
                entry2.bind('<Control_L>', lambda event: entry2_2())
                text2 = ttk.Label(w2, text="循环次数")
                text2.pack(padx=5, pady=5, side='right')
                text_widget.delete(1.0, END)
                w.grid_remove()
                w3 = ttk.Frame(self.window)
            ...
            if f.winfo_viewable():
                ...
                entry.bind('<Control_L>', lambda event: entry2_2())
            else:
                combo.grid_remove()
                w2 = ttk.Frame(self.window)
                w2.grid(row=0, column=0, sticky=W)
                ...
                def x1_x():
                    ...
                    def combobox_():
                        try:
                            ...
                            messagebox.showerror("错误，已退出循环", f"发生错误: {e}\n可能与文件是否设置有关", parent=self.window)
                            entry2_2_1()
                    ...
                    match t:
                        ...
                        case _:
                            combobox.set("顺序数据【空亡定为6】")
                            combobox_save()
                    combobox.bind('<Control_R>', lambda event: combobox_())
                    window_x.bind('<Control_R>', lambda event: combobox_())
                    combobox.bind('<Control_L>', lambda event: entry2_2_1())
                    window_x.bind('<Control_L>', lambda event: entry2_2_1())
                    combobox.bind("<<ComboboxSelected>>", lambda event: combobox_save())
        ...
        down_box = ttk.Combobox(self.window, values=["返回主页"], state="readonly")
        down_box.grid(row=0, column=0, padx=5, pady=5, sticky="e")
        down_box.bind("<Button-3>", lambda event: event_t())
        down_box.set("返回主页")
        scrollbar = ttk.Scrollbar(self.window, style="round")
        scrollbar.grid(row=1, column=1, sticky="ns")
        text_widget = tk.Text(self.window, wrap="word",
