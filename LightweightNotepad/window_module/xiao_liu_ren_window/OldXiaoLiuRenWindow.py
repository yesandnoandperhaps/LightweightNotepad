...
from LightweightNotepad.window_module.xiao_liu_ren_window.OldXiaoLiuRenWindowPatch import LabelManager
from LightweightNotepad.window_module.xiao_liu_ren_window.NewXiaoLiuRenWindow import NewX
from LightweightNotepad.function.ProjectFunctions import t_save, t_load
from LightweightNotepad.function.variables.ProjectPathVariables import N_PATH, P_PATH, Q_PATH, U_PATH, V_PATH, ICON_PATH
